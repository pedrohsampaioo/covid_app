...
class SummaryGlobalWidget extends StatefulWidget {
  final SummaryCubit summaryCubit;

  const SummaryGlobalWidget({
    Key key,
  ...
  @override
  _SummaryGlobalWidgetState createState() => _SummaryGlobalWidgetState();
}

class _SummaryGlobalWidgetState extends State<SummaryGlobalWidget> {
  @override
  void initState() {
    super.initState();
    widget.summaryCubit.state.maybeMap(
      orElse: () => widget.summaryCubit.global(),
      loadInProgress: (_) {},
      loadSuccess: (_) {},
    );
  }
        ...
        return AnimatedSwitcher(
          ...
          child: state.map<Widget>(
            ...
            loadFailure: (_) => ErrorTemplateWidget(
              refreshAction: () async => await widget.summaryCubit.global(),
              message:
